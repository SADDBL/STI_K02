...
#define TCS34725_ADDRESS          (0x29)    /* TCS34725µÿ÷∑ */
...
#define TCS_SDA_IN(void)  {SDA_GPIO_Port->CRH&=0xFFFF0FFF;SDA_GPIO_Port->CRH|=8<<12;}
#define TCS_SDA_OUT(void) {SDA_GPIO_Port->CRH&=0xFFFF0FFF;SDA_GPIO_Port->CRH|=3<<12;}
#define TCS_SDA_READ   SDA_GPIO_Port->IDR&(1<<11)

#define TCS_SCL_H     HAL_GPIO_WritePin(SCL_GPIO_Port,SCL_Pin,GPIO_PIN_SET) //GPIO_SetBits(SCL_GPIO_Port,GPIO_Pin_10)
#define TCS_SCL_L     HAL_GPIO_WritePin(SCL_GPIO_Port,SCL_Pin,GPIO_PIN_RESET) //GPIO_ResetBits(SCL_GPIO_Port,GPIO_Pin_10)
#define TCS_SDA_H     HAL_GPIO_WritePin(SDA_GPIO_Port,SDA_Pin,GPIO_PIN_SET) //GPIO_SetBits(SDA_GPIO_Port,GPIO_Pin_11)
#define TCS_SDA_L     HAL_GPIO_WritePin(SDA_GPIO_Port,SDA_Pin,GPIO_PIN_RESET) //GPIO_ResetBits(SDA_GPIO_Port,GPIO_Pin_11)
/******************************************************************************/
